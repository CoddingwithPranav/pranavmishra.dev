...
export default function RetroCard({ year, title, description, views }: RetroCardProps) {
  return (
    <div className="relative h-[20rem] p-6 bg-gradient-to-br from-card/95 via-card/80 to-card/95 dark:from-card/20 dark:via-card/10 dark:to-card/20 backdrop-blur-2xl shadow-xl rounded-2xl border border-border/30 dark:border-border/40 transition-all duration-500 max-w-sm w-full mx-auto hover:shadow-2xl hover:-translate-y-3 group overflow-hidden">
